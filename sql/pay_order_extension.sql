CREATE TABLE `erp_finance_payment`  (
  ...
  `payment_time` datetime(0) NOT NULL COMMENT '付款时间',
  `finance_user_id` int(10) NULL DEFAULT NULL COMMENT '财务人员编号',
  `supplier_id` int(10) NOT NULL COMMENT '供应商编号',
  `account_id` int(10) NOT NULL COMMENT '付款账户编号',
...
CREATE TABLE `erp_finance_payment_item`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `payment_id` int(10) NOT NULL COMMENT '付款单编号',
  `biz_type` tinyint(4) NOT NULL COMMENT '业务类型',
  `biz_id` int(10) NOT NULL COMMENT '业务编号',
...
CREATE TABLE `pay_channel`  (
  ...
  `tenant_id` int(10) NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '支付渠道' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_demo_order`  (
  ...
  `tenant_id` int(10) NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 204 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '示例订单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_notify_task`  (
  ...
  `tenant_id` int(10) NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 540 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商户支付、退款等的通知' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_order`  (
  ...
  `tenant_id` int(10) NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '支付订单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_order_extension`  (
  ...
  `tenant_id` int(10) NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '支付订单' ROW_FORMAT = Dynamic;
