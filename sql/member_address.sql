...
CREATE TABLE `member_address`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '收件地址编号',
  ...
  `area_id` int(10) NOT NULL COMMENT '地区编码',
...
CREATE TABLE `member_config`  (
  ...
  `point_trade_deduct_enable` tinyint(1) NOT NULL COMMENT '是否开启积分抵扣',
  ...
  `point_trade_give_point` int(10) NULL DEFAULT NULL COMMENT '1 元赠送多少分',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 64 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员经验记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `member_experience_record` VALUES (63, 285, '222', 11, '下单奖励', '下单获得 100 经验', 100, 400, '285', '2025-07-26 20:41:06', '285', '2025-07-26 20:41:06', b'0', 1);
...
CREATE TABLE `member_level_record`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `user_id` int(10) NOT NULL DEFAULT 0 COMMENT '用户编号',
  `level_id` int(10) NOT NULL DEFAULT 0 COMMENT '等级编号',
...
) ENGINE = InnoDB AUTO_INCREMENT = 92 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户积分记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `member_point_record` VALUES (89, 285, '1', 2, '管理员修改', '管理员修改 110 积分', 110, 119, '1', '2025-07-26 20:06:30', '1', '2025-07-26 20:06:30', b'0', 1);
INSERT INTO `member_point_record` VALUES (90, 285, '222', 11, '订单积分抵扣', '下单使用 -5 积分', -5, 114, '285', '2025-07-26 20:18:08', '285', '2025-07-26 20:18:08', b'0', 1);
INSERT INTO `member_point_record` VALUES (91, 285, '222', 21, '订单积分奖励', '下单获得 3 积分', 3, 117, '285', '2025-07-26 20:41:06', '285', '2025-07-26 20:41:06', b'0', 1);
...
CREATE TABLE `member_sign_in_record`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '签到自增id',
  `user_id` int(11) NULL DEFAULT NULL COMMENT '签到用户',
  `day` int(11) NULL DEFAULT NULL COMMENT '第几天签到',
  `point` int(11) NOT NULL DEFAULT 0 COMMENT '签到的分数',
  `experience` int(11) NOT NULL DEFAULT 0 COMMENT '奖励经验',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
...
CREATE TABLE `member_user`  (
  ...
  `area_id` int(10) NULL DEFAULT NULL COMMENT '所在地',
  ...
  `level_id` int(10) NULL DEFAULT NULL COMMENT '等级编号',
  `experience` int(11) NOT NULL DEFAULT 0 COMMENT '经验',
  `group_id` int(10) NULL DEFAULT NULL COMMENT '用户分组编号',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
...
INSERT INTO `member_user` VALUES (285, '18601650373', '$2a$04$xTYFGI/RQ2P0uvR0N9xFXuLwubffpAt6RMvyg0S2zsaoJtIuKVkBK', 0, '127.0.0.1', 20, '192.168.12.3', '2025-09-20 20:34:50', '刘吉国', 'http://test.yudao.iocoder.cn/524fb8e6aa7060ff1b3a4cf32805b906fc68f748cfab389c0efd5b5336c6a401.jpg', '', 1, 310112, '2025-07-26 00:00:00', NULL, 117, '1', 1, 400, 1, NULL, '2024-01-17 15:41:01', NULL, '2025-09-20 20:34:50', b'0', 1);