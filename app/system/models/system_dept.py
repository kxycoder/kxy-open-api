...
class SystemDept(BaseEntity, Base):
    ...
    def get_mini_fields():
        """返回精简信息字段"""
        return [SystemDept.id,SystemDept.name,SystemDept.parentId,SystemDept.sort,SystemDept.leaderUserId,SystemDept.defaultRoles,SystemDept.phone,SystemDept.email,SystemDept.tenantId,SystemDept.status]