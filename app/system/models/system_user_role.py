...
class SystemUserRole(BaseEntity, Base):
    def __init__(self):
    ...
    InsertRequireFields = ['userId', 'roleId']
    ...
    def get_mini_fields():
        """返回精简信息字段"""
        return [SystemUserRole.id,SystemUserRole.userId,SystemUserRole.roleId,SystemUserRole.tenantId]