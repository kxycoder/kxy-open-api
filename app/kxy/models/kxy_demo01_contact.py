...
@FilterTenant()
class KxyDemo01Contact(BaseEntity, Base):
    def __init__(self):
        super().__init__(id_type='int',auto_id=False)
        
    __tablename__ = 'kxy_demo01_contact'
    ...
    birthday = Column('birthday',DateTime, comment='出生年')
    ...
    InsertOtherFields= ['name', 'description', 'avatar']
    ...
    def get_mini_fields():
        """返回精简信息字段"""
        return [KxyDemo01Contact.id,KxyDemo01Contact.name,KxyDemo01Contact.sex,KxyDemo01Contact.birthday,KxyDemo01Contact.description,KxyDemo01Contact.avatar]