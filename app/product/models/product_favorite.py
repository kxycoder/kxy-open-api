...
@FilterTenant()
class ProductFavorite(BaseEntity, Base):
    def __init__(self):
    ...
    id = Column('id',Integer, comment='收藏编号',primary_key=True,autoincrement=True)
    ...
    InsertRequireFields = ['userId', 'spuId']
    ...
    def get_mini_fields():
        """返回精简信息字段"""
        return [ProductFavorite.id,ProductFavorite.userId,ProductFavorite.spuId,ProductFavorite.index]